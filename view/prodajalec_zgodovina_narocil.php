...
<div class="container-lg" style="height:100%;">
  ...
  -->
	<div class="card border-dark" style="height:100%" >
		<div class="card-header bg-dark text-white" >Zgodovina potrjenih naročil</div>
			...
			<ul class="list-group" style="width:100%; height:100%;">
                            ...
                            <li class="list-group-item  align-items-center ">
                                ...
                                <div class="col-sm-3">
                                <form method="post">
                                    <input type="hidden" name="do" value="storniraj_narocilo">
                                    <input type="hidden" name="id_t_narocila" value="<?=$tabTrenutnaNarocila[$i]["id"]?>">
                                <button type="submit" class="btn btn-danger"><i class="fas fa-times"></i> Storniraj naročilo</button>
                                </form>
                                </div>
