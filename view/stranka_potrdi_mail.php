...
<div class="container-lg d-flex justify-content-center" style="height:100%; width:100%; margin-top:3vh;">
  ...
  <div class="card border-dark" style="height:60%; width:60%;" >
		<div class="card-header bg-dark text-white" ><i class="fas fa-store"></i> <b><i>Trgovina abc</i></b></div>
			...
			<h4 class="text-dark"> <b class="">Preglejte svojo epošto</b></h4><br>
            <h6 class="text-dark">Poslali smo vam potrditveni email s povezavo za prijavo.</h6>
