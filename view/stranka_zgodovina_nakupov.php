...
<div class="container-lg" style="height:100%;">
  ...
  <div class="card border-dark" style="height:100%" >
		<div class="card-header bg-dark text-white" >Zgodovina nakupov</div>
			...
			<ul class="list-group" style="width:100%; height:100%;">
                        ...
                        <?php for($i = 0; $i < count($tabIDji); $i++) { ?>
			<li class="list-group-item  align-items-center ">
			
                            <!-- posamezno narocilo -->
                            <h6><b>Naročilo (id: <?=$tabIDji[$i]?>)</b></h6> <span class="badge badge-primary">Status: <?=$tabStatusov[$i]?></span><br><br>
                            <p>Naročil: <?= $stranka["ime"] ?> <?= $stranka["priimek"]?></p>

                            <ul>
                                <?php foreach($tabNakupov[$i] as $artikel): ?>
                                                <li>
