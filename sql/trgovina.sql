...
CREATE TABLE IF NOT EXISTS `trgovina`.`narocila` (
  ...
  CONSTRAINT `fk_narocila_uporabniki1`
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `trgovina`.`podrobnosti_narocila` ;
...
CREATE TABLE IF NOT EXISTS `trgovina`.`podrobnosti_narocila` (
  ...
  CONSTRAINT `fk_podrobnosti_narocila_artikli`
    FOREIGN KEY (`artikli_id`)
    REFERENCES `trgovina`.`artikli` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
