...
INSERT INTO `artikli` (`id`,`ime`,`avtor`,`zalozba`,`cena`,`slike`,`naslov_slike`,`active`) VALUES (7,'Harry Potter','J.K. Rowling','Mladinska',50,NULL,'https://images-na.ssl-images-amazon.com/images/I/81iqZ2HHD-L.jpg',0);
INSERT INTO `artikli` (`id`,`ime`,`avtor`,`zalozba`,`cena`,`slike`,`naslov_slike`,`active`) VALUES (8,'Gospodar Prstanov','J.R.R. Tolkien','Mladinska Knjiga',20,NULL,'https://images-na.ssl-images-amazon.com/images/I/8134AkhQJgL.jpg',1);
INSERT INTO `artikli` (`id`,`ime`,`avtor`,`zalozba`,`cena`,`slike`,`naslov_slike`,`active`) VALUES (9,'Stoparski vodic po galaksiji','Douglas Adams','Mladinska Knjiga',30,NULL,'https://images.penguinrandomhouse.com/cover/9781400052929',1);
INSERT INTO `artikli` (`id`,`ime`,`avtor`,`zalozba`,`cena`,`slike`,`naslov_slike`,`active`) VALUES (10,'Test','Avtor','Zalozba test',100,NULL,NULL,1);
INSERT INTO `artikli` (`id`,`ime`,`avtor`,`zalozba`,`cena`,`slike`,`naslov_slike`,`active`) VALUES (11,'Robin Hood','Mladinska Knjiga','Howard Pyle',25,NULL,'https://images-na.ssl-images-amazon.com/images/I/71-8zYH9nIL.jpg',1);